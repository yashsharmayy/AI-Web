...
export function BlogPage() {
  ...
  return <div className="pt-28 pb-20 max-w-7xl mx-auto px-6 md:px-12 space-y-16">
    ...
    className="w-full bg-[#F6F6F6] text-xs text-[#111111] pl-10 pr-4 py-3 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#FF3B30]/30"
  />
        </div>
  ...
  />
            ...
            <div className="space-y-3 px-1">
              ...
              <h2 className="text-xl font-bold font-syne text-[#111111] group-hover:text-[#FF3B30] transition-colors line-clamp-2">
                {blog.title}
              </h2>
              ...
              <div className="pt-3 border-t border-black/6 flex items-center justify-between text-xs font-bold text-[#111111]">
                ...
                <span className="text-[#FF3B30] flex items-center gap-0.5">Read <ArrowUpRight className="w-3.5 h-3.5" /></span>
              </div>
            </div>
          </Link>)}
      </div>
