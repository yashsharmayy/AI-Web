        ...
        <div className="px-2 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold font-syne text-[#111111] group-hover:text-[#6d001a] transition-colors">
                {project.title}
              </h2>
            </div>
            <Link
              to={`/portfolio/${project.slug}`}
              className="w-12 h-12 rounded-full bg-[#F6F6F6] group-hover:bg-[#6d001a] group-hover:text-white transition-colors flex items-center justify-center text-[#111111]"
