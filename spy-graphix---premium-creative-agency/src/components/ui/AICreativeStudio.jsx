...
export function AICreativeStudio() {
  ...
  return <div className="w-full bg-[#FFFFFF] rounded-3xl p-6 md:p-10 border border-black/8 shadow-soft space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-black/6 pb-6">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FF3B30]/10 text-[#FF3B30] text-xs font-semibold uppercase tracking-wider">
  ...
  >
    ...
    className="w-full bg-[#F6F6F6] border border-black/8 rounded-2xl p-4 text-sm text-[#111111] placeholder:text-[#999999] focus:outline-none focus:ring-2 focus:ring-[#FF3B30]/30 resize-none"
  />
          <button
    type="submit"
    disabled={loading || !prompt.trim()}
    className="absolute bottom-3 right-3 bg-[#FF3B30] hover:bg-[#E02E24] text-white font-medium text-xs px-5 py-2.5 rounded-xl transition-all shadow-md disabled:opacity-50 flex items-center gap-2"
